...
target_cols = ['ind_cco_fin_ult1', 'ind_cder_fin_ult1', 'ind_cno_fin_ult1', 'ind_ctju_fin_ult1', 'ind_ctma_fin_ult1', 'ind_ctop_fin_ult1', 'ind_ctpp_fin_ult1', 'ind_deco_fin_ult1', 'ind_deme_fin_ult1', 'ind_dela_fin_ult1',
...
products_indexes = {
    'ind_cco_fin_ult1': 18, 'ind_cder_fin_ult1': 19, 'ind_cno_fin_ult1': 20, 'ind_ctju_fin_ult1': 21, 'ind_ctma_fin_ult1': 22, 'ind_ctop_fin_ult1': 23, 'ind_ctpp_fin_ult1': 24, 'ind_deco_fin_ult1': 25, 'ind_deme_fin_ult1': 26, 'ind_dela_fin_ult1': 27,
    'ind_ecue_fin_ult1': 28, 'ind_fond_fin_ult1': 29, 'ind_hip_fin_ult1': 30, 'ind_plan_fin_ult1': 31, 'ind_pres_fin_ult1': 32, 'ind_reca_fin_ult1': 33, 'ind_tjcr_fin_ult1': 34, 'ind_valo_fin_ult1': 35, 'ind_viv_fin_ult1': 36, 'ind_nomina_ult1': 37, 'ind_nom_pens_ult1': 38, 'ind_recibo_ult1': 39
}
product_mapping = {
...
def filterResult(result, id):
    products = np.array(target_cols)
    result = np.argsort(result, axis=1)
    result = np.fliplr(result)[:, :7]
    test_id = [id]
    array_result = [(list(products[pred])) for pred in result]
    final_result = list(map(mapProduct, array_result[0]))
    return final_result


def mapProduct(product_code):
    return {
        'code': product_code,
        'name': product_mapping[product_code]
    }
